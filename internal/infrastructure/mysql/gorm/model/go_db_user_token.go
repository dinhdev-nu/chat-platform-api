...
type UserToken struct {
	...
	ExpiresAt  time.Time `gorm:"column:expires_at;not null;index:idx_token_expires" json:"expires_at"`
	LastUsedAt time.Time `gorm:"column:last_used_at;not null;default:CURRENT_TIMESTAMP;autoUpdateTime;index:idx_token_last_used,priority:2" json:"last_used_at"`
